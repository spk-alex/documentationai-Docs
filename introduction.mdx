...
**Download:** [openapi.yaml](https://raw.githubusercontent.com/spk-alex/documentationai-Docs/main/openapi.yaml) — use this to generate clients or explore the API in tools like Postman or Swagger UI.
